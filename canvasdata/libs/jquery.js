...
jQuery.fn.extend({
	...
	//扩展光标位置 By:Liangbo 2012-10-15
	,setCursorPosition:function(pos){
	   if(this.lengh == 0) return this;
	   return this.setInputSelection(pos, pos);
	},
	
	setInputSelection:function(selectionStart, selectionEnd) {
    if(this.lengh == 0) return this;
    input = this[0];
